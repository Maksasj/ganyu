        ...
        BODY("") {
            DIV("style='width:100%; height:100%; display:grid; place-items: center'") {
                if(!res) {
                    ...
                    DIV("style='text-align: center;'") {
                        H1("☠️ Failed to modify directory 😵‍💫");
                        A("href='/directory?id=%s' style='margin-right: 7px;'", idField->fieldValue) { B("I will try to do it again ! 👻"); }
                        A("href='/directory?id=%s' style='margin-left: 7px;'", idField->fieldValue) { B("Ok 👽"); }
                    }
                }
