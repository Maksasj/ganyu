...
CHTTPResponse* deldir_page(CHTTPConnection* con, CHTTPRequest* request) {
    ...
    "DELETE FROM ganyu.VirtualDirectory AS VD \
        ...
        BODY("") {
            DIV("style='width:100%; height:100%; display:grid; place-items: center'") {
                DIV("style='text-align: center;'") {
                    H1("🎉 Directory successfully deleted 🎉");
                    A("href='/directories' style='margin-right: 7px;'") { B("Ok 🌚"); }
                    A("href='/directories' style='margin-left: 7px;'") { B("Thank you ! 💖"); }
                }
            }
        }
    } 
